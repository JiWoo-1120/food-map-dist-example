...
var options = { //지도를 생성할 때 필요한 기본 옵션
	center: new kakao.maps.LatLng(37.478166, 126.881527), //지도의 중심좌표.
...
async function getDataSet(category){
	...
	const dataSet = await axios({
		method: "get",
		url: `https://www.hahahagood.shop/restaurants?category=${qs}`,
		headers: {},
		data: {}
	});
...
function getContent(data){
	...
	<div class="infowindow">
      ...
      <div class="infowindow-body">
        ...
        <a href="${data.videoUrl}" class="infowindow-btn" target="_blank">영상보기</a>
      </div>
    </div>
	`
}
...
// for 문을 이용해 setMap에서 생성된 마커를 하나씩 닫아준다.
let infowindowArray = [];
